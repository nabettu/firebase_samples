...
},{"decode-uri-component":21,"object-assign":22,"strict-uri-encode":24}],24:[function(require,module,exports){
'use strict';
...
var Login = function () {
    ...
    (0, _createClass3.default)(Login, [{
        key: 'btnSetup',
        value: function btnSetup() {
            var _this = this;

            $('.js-loginBtn').on('click', function (e) {
                var oauthType = e.target.dataset.type;
        ...
        value: function setUserInfo(user) {
            ...
            var firebaseDB = firebase.database().ref('users/' + user.uid);

            firebaseDB.once('value').then(function (res) {
                console.log(res.val());
                if (!res.val()) {
                    firebaseDB.set({
...
},{"babel-runtime/helpers/classCallCheck":2,"babel-runtime/helpers/createClass":3}],26:[function(require,module,exports){
'use strict';
...
},{"babel-runtime/helpers/classCallCheck":2,"babel-runtime/helpers/createClass":3,"query-string":23}],27:[function(require,module,exports){
'use strict';
...
var bodyClassName = $('body').attr('id');
